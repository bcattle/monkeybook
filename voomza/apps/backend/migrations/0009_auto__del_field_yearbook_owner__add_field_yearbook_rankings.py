...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Yearbook.owner'
        db.delete_column('backend_yearbook', 'owner_id')

        # Adding field 'Yearbook.rankings'
        db.add_column('backend_yearbook', 'rankings',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, related_name='yearbook', unique=True, to=orm['backend.PhotoRankings']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Yearbook.owner'
        db.add_column('backend_yearbook', 'owner',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=7, related_name='yearbooks', unique=True, to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'Yearbook.rankings'
        db.delete_column('backend_yearbook', 'rankings_id')
