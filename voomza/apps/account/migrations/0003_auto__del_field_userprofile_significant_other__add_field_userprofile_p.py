...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.significant_other'
        db.delete_column('account_userprofile', 'significant_other_id')

        # Adding field 'UserProfile.pic_square'
        db.add_column('account_userprofile', 'pic_square',
    ...
    def backwards(self, orm):
        # Adding field 'UserProfile.significant_other'
        db.add_column('account_userprofile', 'significant_other',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['account.YearbookFacebookUser']),
                      keep_default=False)

        # Deleting field 'UserProfile.pic_square'
        db.delete_column('account_userprofile', 'pic_square')
