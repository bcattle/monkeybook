...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Yearbook', fields ['rankings']
        db.delete_unique('backend_yearbook', ['rankings_id'])

        # Removing unique constraint on 'PhotoRankings', fields ['user']
        db.delete_unique('backend_photorankings', ['user_id'])


        # Changing field 'PhotoRankings.user'
        db.alter_column('backend_photorankings', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Yearbook.rankings'
        db.alter_column('backend_yearbook', 'rankings_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['backend.PhotoRankings']))

    def backwards(self, orm):

        # Changing field 'PhotoRankings.user'
        db.alter_column('backend_photorankings', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['auth.User']))
        # Adding unique constraint on 'PhotoRankings', fields ['user']
        db.create_unique('backend_photorankings', ['user_id'])


        # Changing field 'Yearbook.rankings'
        db.alter_column('backend_yearbook', 'rankings_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['backend.PhotoRankings']))
        # Adding unique constraint on 'Yearbook', fields ['rankings']
        db.create_unique('backend_yearbook', ['rankings_id'])
