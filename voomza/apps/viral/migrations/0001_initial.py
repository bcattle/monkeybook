...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'viral_inviterequestsent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('from_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'invites_sent', to=orm['auth.User'])),
        ...
        db.send_create_signal(u'viral', ['InviteRequestSent'])


    def backwards(self, orm):
        # Deleting model 'InviteRequestSent'
        db.delete_table(u'viral_inviterequestsent')
    ...
    models = {
        ...
        u'viral.inviterequestsent': {
            'Meta': {'object_name': 'InviteRequestSent'},
            'accepted_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'from_user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'invites_sent'", 'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'request_id': ('django.db.models.fields.BigIntegerField', [], {}),
            'sent_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'to_facebook_user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['account.FacebookUser']"})
        }
    }
