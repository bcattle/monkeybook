...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Yearbook.hash'
        db.add_column('backend_yearbook', 'hash',
                      self.gf('django.db.models.fields.CharField')(default='deadbeef', unique=True, max_length=20, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Yearbook.hash'
        db.delete_column('backend_yearbook', 'hash')
