...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PhotoRankings.top_posts'
        db.add_column('backend_photorankings', 'top_posts',
                      self.gf('jsonfield.fields.JSONField')(default='[]', max_length=100000),
                      keep_default=False)


        # Changing field 'Yearbook.top_post'
        db.alter_column('backend_yearbook', 'top_post', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

    def backwards(self, orm):
        # Deleting field 'PhotoRankings.top_posts'
        db.delete_column('backend_photorankings', 'top_posts')


        # Changing field 'Yearbook.top_post'
        db.alter_column('backend_yearbook', 'top_post', self.gf('jsonfield.fields.JSONField')(max_length=100000))
