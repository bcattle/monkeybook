...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'YearbookFacebookUser', fields ['facebook_id']
        db.create_index('account_yearbookfacebookuser', ['facebook_id'])

        # Adding unique constraint on 'YearbookFacebookUser', fields ['facebook_id']
        db.create_unique('account_yearbookfacebookuser', ['facebook_id'])

        # Adding index on 'UserProfile', fields ['facebook_id']
        db.create_index('account_userprofile', ['facebook_id'])


    def backwards(self, orm):
        # Removing index on 'UserProfile', fields ['facebook_id']
        db.delete_index('account_userprofile', ['facebook_id'])

        # Removing unique constraint on 'YearbookFacebookUser', fields ['facebook_id']
        db.delete_unique('account_yearbookfacebookuser', ['facebook_id'])

        # Removing index on 'YearbookFacebookUser', fields ['facebook_id']
        db.delete_index('account_yearbookfacebookuser', ['facebook_id'])
