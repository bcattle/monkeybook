...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FacebookPhoto.all_sizes'
        db.add_column(u'backend_facebookphoto', 'all_sizes',
                      self.gf('jsonfield.fields.JSONField')(default=u'[]', max_length=100000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FacebookPhoto.all_sizes'
        db.delete_column(u'backend_facebookphoto', 'all_sizes')
