...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.facebook_user'
        db.alter_column('account_userprofile', 'facebook_user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['account.FacebookUser']))
        # Adding unique constraint on 'UserProfile', fields ['facebook_user']
        db.create_unique('account_userprofile', ['facebook_user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserProfile', fields ['facebook_user']
        db.delete_unique('account_userprofile', ['facebook_user_id'])


        # Changing field 'UserProfile.facebook_user'
        db.alter_column('account_userprofile', 'facebook_user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['account.FacebookUser']))
