...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'YearbookFacebookUser.pic_small'
        db.delete_column('account_yearbookfacebookuser', 'pic_small')

        # Adding field 'YearbookFacebookUser.pic_square'
        db.add_column('account_yearbookfacebookuser', 'pic_square',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'YearbookFacebookUser.pic_small'
        db.add_column('account_yearbookfacebookuser', 'pic_small',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Deleting field 'YearbookFacebookUser.pic_square'
        db.delete_column('account_yearbookfacebookuser', 'pic_square')
