...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PhotoRankings.top_photos_first_half'
        db.delete_column('backend_photorankings', 'top_photos_first_half')

        # Deleting field 'PhotoRankings.top_photos_second_half'
        db.delete_column('backend_photorankings', 'top_photos_second_half')

        # Deleting field 'Yearbook.second_half_photo_5'
        db.delete_column('backend_yearbook', 'second_half_photo_5')

        # Deleting field 'Yearbook.second_half_photo_4'
        db.delete_column('backend_yearbook', 'second_half_photo_4')

        # Deleting field 'Yearbook.second_half_photo_3'
        db.delete_column('backend_yearbook', 'second_half_photo_3')

        # Deleting field 'Yearbook.second_half_photo_2'
        db.delete_column('backend_yearbook', 'second_half_photo_2')

        # Deleting field 'Yearbook.second_half_photo_1'
        db.delete_column('backend_yearbook', 'second_half_photo_1')

        # Deleting field 'Yearbook.first_half_photo_4'
        db.delete_column('backend_yearbook', 'first_half_photo_4')

        # Deleting field 'Yearbook.first_half_photo_5'
        db.delete_column('backend_yearbook', 'first_half_photo_5')

        # Deleting field 'Yearbook.first_half_photo_1'
        db.delete_column('backend_yearbook', 'first_half_photo_1')

        # Deleting field 'Yearbook.first_half_photo_2'
        db.delete_column('backend_yearbook', 'first_half_photo_2')

        # Deleting field 'Yearbook.first_half_photo_3'
        db.delete_column('backend_yearbook', 'first_half_photo_3')

        # Adding field 'Yearbook.group_photo_2'
        db.add_column('backend_yearbook', 'group_photo_2',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Yearbook.group_photo_3'
        db.add_column('backend_yearbook', 'group_photo_3',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Yearbook.year_photo_1'
        db.add_column('backend_yearbook', 'year_photo_1',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Yearbook.year_photo_2'
        db.add_column('backend_yearbook', 'year_photo_2',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Yearbook.year_photo_3'
        db.add_column('backend_yearbook', 'year_photo_3',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Yearbook.year_photo_4'
        db.add_column('backend_yearbook', 'year_photo_4',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Yearbook.year_photo_5'
        db.add_column('backend_yearbook', 'year_photo_5',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Yearbook.year_photo_6'
        db.add_column('backend_yearbook', 'year_photo_6',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Yearbook.year_photo_7'
        db.add_column('backend_yearbook', 'year_photo_7',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Yearbook.year_photo_8'
        db.add_column('backend_yearbook', 'year_photo_8',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Yearbook.year_photo_9'
        db.add_column('backend_yearbook', 'year_photo_9',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PhotoRankings.top_photos_first_half'
        db.add_column('backend_photorankings', 'top_photos_first_half',
                      self.gf('jsonfield.fields.JSONField')(default='[]', max_length=100000),
                      keep_default=False)

        # Adding field 'PhotoRankings.top_photos_second_half'
        db.add_column('backend_photorankings', 'top_photos_second_half',
                      self.gf('jsonfield.fields.JSONField')(default='[]', max_length=100000),
                      keep_default=False)

        # Adding field 'Yearbook.second_half_photo_5'
        db.add_column('backend_yearbook', 'second_half_photo_5',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Yearbook.second_half_photo_4'
        db.add_column('backend_yearbook', 'second_half_photo_4',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Yearbook.second_half_photo_3'
        db.add_column('backend_yearbook', 'second_half_photo_3',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Yearbook.second_half_photo_2'
        db.add_column('backend_yearbook', 'second_half_photo_2',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Yearbook.second_half_photo_1'
        db.add_column('backend_yearbook', 'second_half_photo_1',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Yearbook.first_half_photo_4'
        db.add_column('backend_yearbook', 'first_half_photo_4',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Yearbook.first_half_photo_5'
        db.add_column('backend_yearbook', 'first_half_photo_5',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Yearbook.first_half_photo_1'
        db.add_column('backend_yearbook', 'first_half_photo_1',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Yearbook.first_half_photo_2'
        db.add_column('backend_yearbook', 'first_half_photo_2',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Yearbook.first_half_photo_3'
        db.add_column('backend_yearbook', 'first_half_photo_3',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)

        # Deleting field 'Yearbook.group_photo_2'
        db.delete_column('backend_yearbook', 'group_photo_2')

        # Deleting field 'Yearbook.group_photo_3'
        db.delete_column('backend_yearbook', 'group_photo_3')

        # Deleting field 'Yearbook.year_photo_1'
        db.delete_column('backend_yearbook', 'year_photo_1')

        # Deleting field 'Yearbook.year_photo_2'
        db.delete_column('backend_yearbook', 'year_photo_2')

        # Deleting field 'Yearbook.year_photo_3'
        db.delete_column('backend_yearbook', 'year_photo_3')

        # Deleting field 'Yearbook.year_photo_4'
        db.delete_column('backend_yearbook', 'year_photo_4')

        # Deleting field 'Yearbook.year_photo_5'
        db.delete_column('backend_yearbook', 'year_photo_5')

        # Deleting field 'Yearbook.year_photo_6'
        db.delete_column('backend_yearbook', 'year_photo_6')

        # Deleting field 'Yearbook.year_photo_7'
        db.delete_column('backend_yearbook', 'year_photo_7')

        # Deleting field 'Yearbook.year_photo_8'
        db.delete_column('backend_yearbook', 'year_photo_8')

        # Deleting field 'Yearbook.year_photo_9'
        db.delete_column('backend_yearbook', 'year_photo_9')
