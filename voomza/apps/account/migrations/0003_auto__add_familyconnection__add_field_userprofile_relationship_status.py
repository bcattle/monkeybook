...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.relationship_status'
        db.add_column('account_userprofile', 'relationship_status',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UserProfile.relationship_status'
        db.delete_column('account_userprofile', 'relationship_status')
