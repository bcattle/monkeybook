...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Yearbook.top_photo_4'
        db.add_column('backend_yearbook', 'top_photo_4',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Yearbook.top_photo_5'
        db.add_column('backend_yearbook', 'top_photo_5',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Yearbook.top_photo_4'
        db.delete_column('backend_yearbook', 'top_photo_4')

        # Deleting field 'Yearbook.top_photo_5'
        db.delete_column('backend_yearbook', 'top_photo_5')
