...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Yearbook.top_post'
        db.add_column('backend_yearbook', 'top_post',
                      self.gf('jsonfield.fields.JSONField')(default=[], max_length=100000),
                      keep_default=False)

        # Adding field 'Yearbook.birthday_posts'
        db.add_column('backend_yearbook', 'birthday_posts',
                      self.gf('jsonfield.fields.JSONField')(default=[], max_length=100000),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Yearbook.top_post'
        db.delete_column('backend_yearbook', 'top_post')

        # Deleting field 'Yearbook.birthday_posts'
        db.delete_column('backend_yearbook', 'birthday_posts')
