...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Yearbook.top_album_1_photo_4'
        db.add_column('backend_yearbook', 'top_album_1_photo_4',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Yearbook.top_album_2_photo_4'
        db.add_column('backend_yearbook', 'top_album_2_photo_4',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Yearbook.top_album_3_photo_4'
        db.add_column('backend_yearbook', 'top_album_3_photo_4',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Yearbook.top_album_1_photo_4'
        db.delete_column('backend_yearbook', 'top_album_1_photo_4')

        # Deleting field 'Yearbook.top_album_2_photo_4'
        db.delete_column('backend_yearbook', 'top_album_2_photo_4')

        # Deleting field 'Yearbook.top_album_3_photo_4'
        db.delete_column('backend_yearbook', 'top_album_3_photo_4')
