...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('backend_facebookphoto', (
            ...
            ('local_url', self.gf('django.db.models.fields.CharField')(default='', max_length=200)),
            ('comments', self.gf('jsonfield.fields.JSONField')(default='[]', max_length=100000)),
        ))
        db.send_create_signal('backend', ['FacebookPhoto'])
        ...
        db.create_table('backend_photorankings', (
            ...
            ('top_photos_second_half', self.gf('jsonfield.fields.JSONField')(default='[]', max_length=100000)),
            ...
            ('top_albums_info', self.gf('jsonfield.fields.JSONField')(default='[]', max_length=100000)),
            ('back_in_time', self.gf('jsonfield.fields.JSONField')(default='[]', max_length=100000)),
        ))
        ...
        db.create_table('backend_yearbook', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('rankings', self.gf('django.db.models.fields.related.ForeignKey')(related_name='yearbook', to=orm['backend.PhotoRankings'])),
            ...
            ('first_half_photo_1', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True)),
            ('first_half_photo_2', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True)),
            ('first_half_photo_3', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True)),
            ('first_half_photo_4', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True)),
            ('first_half_photo_5', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True)),
            ('second_half_photo_1', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True)),
            ('second_half_photo_2', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True)),
            ('second_half_photo_3', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True)),
            ('second_half_photo_4', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True)),
            ('second_half_photo_5', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True)),
            ...
            ('top_post', self.gf('jsonfield.fields.JSONField')(default='[]', max_length=100000)),
            ('birthday_posts', self.gf('jsonfield.fields.JSONField')(default='[]', max_length=100000)),
        ))
        db.send_create_signal('backend', ['Yearbook'])

        # Adding model 'Minibook'
        db.create_table('backend_minibook', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='minibooks_from', to=orm['auth.User'])),
            ('target', self.gf('django.db.models.fields.related.ForeignKey')(related_name='minibooks_to', to=orm['account.FacebookUser'])),
            ('photo_1', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True)),
            ('photo_2', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True)),
            ('photo_3', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True)),
            ('photo_4', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True)),
        ))
        db.send_create_signal('backend', ['Minibook'])

        # Adding model 'MinibookRankings'
        db.create_table('backend_minibookrankings', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('minibook', self.gf('django.db.models.fields.related.OneToOneField')(related_name='photo_rankings', unique=True, to=orm['backend.Minibook'])),
            ('with_target', self.gf('jsonfield.fields.JSONField')(default='[]', max_length=100000)),
            ('your_photos', self.gf('jsonfield.fields.JSONField')(default='[]', max_length=100000)),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table('backend_facebookphoto')

        # Deleting model 'PhotoRankings'
        db.delete_table('backend_photorankings')

        # Deleting model 'Yearbook'
        db.delete_table('backend_yearbook')

        # Deleting model 'Minibook'
        db.delete_table('backend_minibook')
