...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing index on 'Yearbook', fields ['hash']
        db.delete_index(u'backend_yearbook', ['hash'])


    def backwards(self, orm):
        # Adding index on 'Yearbook', fields ['hash']
        db.create_index(u'backend_yearbook', ['hash'])
    ...
    models = {
        ...
        u'backend.yearbook': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '20', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
