...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('account_facebookuser', 'first_name',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


        # Changing field 'FacebookUser.name'
        db.alter_column('account_facebookuser', 'name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):
        # Deleting field 'FacebookUser.first_name'
        db.delete_column('account_facebookuser', 'first_name')


        # Changing field 'FacebookUser.name'
        db.alter_column('account_facebookuser', 'name', self.gf('django.db.models.fields.TextField')(null=True))
