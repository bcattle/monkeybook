...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BadgeVote.to_facebook_user'
        db.delete_column('yearbook_badgevote', 'to_facebook_user_id')

        # Adding field 'BadgeVote.to_facebook_id'
        db.add_column('yearbook_badgevote', 'to_facebook_id',
                      self.gf('django.db.models.fields.BigIntegerField')(default=256),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'BadgeVote.to_facebook_user'
        db.add_column('yearbook_badgevote', 'to_facebook_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=256, to=orm['account.YearbookFacebookUser']),
                      keep_default=False)

        # Deleting field 'BadgeVote.to_facebook_id'
        db.delete_column('yearbook_badgevote', 'to_facebook_id')
