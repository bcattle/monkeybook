...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Yearbook.created'
        db.add_column('backend_yearbook', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 12, 18, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Yearbook.run_time'
        db.add_column('backend_yearbook', 'run_time',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Yearbook.created'
        db.delete_column('backend_yearbook', 'created')

        # Deleting field 'Yearbook.run_time'
        db.delete_column('backend_yearbook', 'run_time')
