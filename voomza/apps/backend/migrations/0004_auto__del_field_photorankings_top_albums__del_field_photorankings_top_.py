...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PhotoRankings.top_albums'
        db.delete_column('backend_photorankings', 'top_albums')

        # Deleting field 'PhotoRankings.top_albums_info'
        db.delete_column('backend_photorankings', 'top_albums_info')

        # Adding field 'PhotoRankings.top_albums_photos'
        db.add_column('backend_photorankings', 'top_albums_photos',
                      self.gf('jsonfield.fields.JSONField')(default='[]', max_length=100000),
                      keep_default=False)

        # Adding field 'PhotoRankings.top_albums_ranked'
        db.add_column('backend_photorankings', 'top_albums_ranked',
                      self.gf('jsonfield.fields.JSONField')(default='[]', max_length=100000),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PhotoRankings.top_albums'
        db.add_column('backend_photorankings', 'top_albums',
                      self.gf('jsonfield.fields.JSONField')(default='[]', max_length=100000),
                      keep_default=False)

        # Adding field 'PhotoRankings.top_albums_info'
        db.add_column('backend_photorankings', 'top_albums_info',
                      self.gf('jsonfield.fields.JSONField')(default='[]', max_length=100000),
                      keep_default=False)

        # Deleting field 'PhotoRankings.top_albums_photos'
        db.delete_column('backend_photorankings', 'top_albums_photos')

        # Deleting field 'PhotoRankings.top_albums_ranked'
        db.delete_column('backend_photorankings', 'top_albums_ranked')
    ...
    models = {
        ...
        'backend.photorankings': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'top_albums_photos': ('jsonfield.fields.JSONField', [], {'default': "'[]'", 'max_length': '100000'}),
            'top_albums_ranked': ('jsonfield.fields.JSONField', [], {'default': "'[]'", 'max_length': '100000'}),
