...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PhotoRankings.top_friends_ids'
        db.add_column('backend_photorankings', 'top_friends_ids',
                      self.gf('jsonfield.fields.JSONField')(default='[]', max_length=100000),
                      keep_default=False)

        # Adding field 'PhotoRankings.top_friends_photos'
        db.add_column('backend_photorankings', 'top_friends_photos',
                      self.gf('jsonfield.fields.JSONField')(default='[]', max_length=100000),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PhotoRankings.top_friends_ids'
        db.delete_column('backend_photorankings', 'top_friends_ids')

        # Deleting field 'PhotoRankings.top_friends_photos'
        db.delete_column('backend_photorankings', 'top_friends_photos')
    ...
    models = {
        ...
        'backend.photorankings': {
            ...
            'top_friends_ids': ('jsonfield.fields.JSONField', [], {'default': "'[]'", 'max_length': '100000'}),
            'top_friends_photos': ('jsonfield.fields.JSONField', [], {'default': "'[]'", 'max_length': '100000'}),
            'top_photos': ('jsonfield.fields.JSONField', [], {'default': "'[]'", 'max_length': '100000'}),
            'top_posts': ('jsonfield.fields.JSONField', [], {'default': "'[]'", 'max_length': '100000'}),
